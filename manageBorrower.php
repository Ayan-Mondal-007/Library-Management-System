...
<body>
  ...
  <div class="sidebar">
    <ul>
        ...
        <li style="background-color:#3a4f5d;font-size:20px"><a href="manageBorrower.php">Manage Borrowers</a></li>
  ...
  <h1>Manage Borrowers</h1>
    ...
    <button class="btn" id="addBookBtn" name="addBorrower"><i class="fa-solid fa-plus" style="margin-right:5px"></i>Add Borrower</button>
    </form>
    <!-- <button class="btn" id="viewBooksBtn">View Books</button> -->
  </div>
